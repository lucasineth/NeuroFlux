...
def paciente_view(request, id):
    ...
    if request.method == 'GET':
        ...
        return render(request, 'paciente_view.html', {'paciente': paciente, 'tarefas': tarefas, 'consultas': consultas, 'tuple_grafico': tuple_grafico})
    elif request.method == 'POST':
        ...
        consultas = Consultas(humor=int(humor), registro_geral=registro_geral, video=video, paciente=paciente)
        consultas.save()
        consultas.tarefas.set(tarefas_ids)
